...
We now have a dataframe that we can use with ggplot2. Here is an excellent ggplot [cheatsheet](https://github.com/rstudio/cheatsheets/blob/master/data-visualization-2.1.pdf). </p>
