...
We now have a dataframe that we can use with the (magnificent) ggplot2. Here is an excellent ggplot2 [cheatsheet](https://github.com/rstudio/cheatsheets/blob/master/data-visualization-2.1.pdf) which I have found useful on many occasions.
<br/>
