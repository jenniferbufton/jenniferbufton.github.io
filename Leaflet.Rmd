...
Below is a map widger with Open Street Map tiles (the default) and circle markers of different colours to differentiate between mixed sessions, and women-only sessions:
